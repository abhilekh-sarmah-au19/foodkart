	...
	<div class="container" id="welcome">
		<div class="card-4 " style="max-width:600px; margin:24px auto;">
			...
			<div class="container p-4 bg-info">
				<h4 class="text-center" style="font-family: 'Courier New', Courier, monospace;"><b>Food Delivery Payment</b></h4><br>
				<h4 class="text-center" style="font-family: 'Courier New', Courier, monospace;"> <b> Amount: Rs. <?php echo $amount; ?></b></h4>
			</div>
