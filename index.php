	...
	<div class="w3-display-container" style="margin-top:71px;">
		...
		<div id="mright" class="w3-display-topright w3-black w3-opacity-min" style="display:none; height:100%;">
			...
			<div class="w3-container w3-bar-block">
				...
				<a href="aboutus.php" class="w3-bar-item w3-button"><i class="fa fa-cog menu-icon"></i>About Us</a>
				<a href="allitems.php" class="w3-bar-item w3-button"><i class="fa fa-cutlery menu-icon"></i>Our Products</a>
				<a href="allitems.php" class="w3-bar-item w3-button"><i class="fa fa-cutlery menu-icon"></i>My Orders</a>
	...
	<div class="w3-container w3-padding-24" style="margin-top:15px">
		<div class="w3-row-padding">
			<div class="w3-third w3-center">
				...
				<p><b>Search</b>
					<br>Browse through thousands of delicious food.
				</p>
			</div>
			...
			<div class="w3-third w3-center">
				...
				<p><b>Order</b>
					<br>Add items to your cart and submit.
				</p>
				</p>
			</div>
	...
	<div class="w3-container w3-padding-24" style="margin-top:15px">
		<div class="w3-row-padding">
			<div class="w3-third w3-center">
				...
				<p><b>Variety</b>
					<br>From Starters to Beverages everything you want.
				</p>
			</div>
			...
			<div class="w3-third w3-center">
				...
				<p><b>Easy Ordering</b>
					<br>Search, order, eat. Simple as that.
				</p>
				</p>
			</div>
			...
			<div class="w3-third w3-center">
				...
				<p><b>Honest Pricing</b>
					<br>No hidden fees. No Delivery Charges.
				</p>
			</div>
		</div>
	</div>
